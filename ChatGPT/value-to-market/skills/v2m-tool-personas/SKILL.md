...
## On invocation
Read `../../references/output-protocol.md`, `../../references/customer-fit.md`, `../../references/frameworks.md` (Premise, Toxic Customer), `../../references/scorecards.md`. Load the archetype map from `v2m-tool-archetype-map` (run it first if missing).

...
## On invocation
Read `../../references/output-protocol.md`, `../../references/frameworks.md` (Value Stick), `../../references/scorecards.md`. Load `.value-to-market/context.md`. Ask for WTP evidence, price, costs, and supplier WTS; mark estimates. Pull the competitor set from `v2m-tool-market-benchmark` if available.

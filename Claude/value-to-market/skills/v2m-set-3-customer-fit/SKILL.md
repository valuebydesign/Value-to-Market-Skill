...
## On invocation
Read `${CLAUDE_PLUGIN_ROOT}/references/output-protocol.md`, `${CLAUDE_PLUGIN_ROOT}/references/customer-fit.md`, `${CLAUDE_PLUGIN_ROOT}/references/frameworks.md`. Confirm the line of business and the reference subjects. Pull values and category from `v2m-set-2-strategy`.

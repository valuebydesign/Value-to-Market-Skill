...
1. Read `${CLAUDE_PLUGIN_ROOT}/references/method-core.md` in full, `${CLAUDE_PLUGIN_ROOT}/references/output-protocol.md`, `${CLAUDE_PLUGIN_ROOT}/references/scorecards.md`.

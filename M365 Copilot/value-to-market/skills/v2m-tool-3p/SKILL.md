...
## On invocation
Read `../../references/output-protocol.md`, `../../references/frameworks.md` (The 3P Framework, Premise, Promise, Proof), `../../references/glossary.md` (promise anatomy), `../../references/scorecards.md`. Pull the core values, the category, the jobs and the personas (including the antithetical personas). Confirm the line of business and ask for any current premise, promise or slogan.

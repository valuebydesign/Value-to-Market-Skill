...
## On invocation
Read `../../references/output-protocol.md`, `../../references/report-format.md`, `../../references/cheatsheets.md`. Read the reasoning files across all numbered phase subfolders, especially the verbalization. Ask the audience, the length, and the single takeaway.

...
- **A package for every tool.** Each release ships one archive per agent, already laid out in that tool's own directory, so you unzip it at the project root and it works:

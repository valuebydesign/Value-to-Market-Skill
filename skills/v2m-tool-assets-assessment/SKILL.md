...
## On invocation
Read `references/output-protocol.md`, `references/frameworks.md` (Assets, Defensibility Ladder, Leverage), `references/scorecards.md`. Load `.value-to-market/context.md`. Ask the user what they own, and search the industry and category if enabled.

...
## On invocation
Read `references/output-protocol.md` and `references/cheatsheets.md`. Ask which cheatsheet: a set (Assess / Strategy / Customer & Fit / Design / Market / Engineer / Deliver), a single framework, or the whole method.

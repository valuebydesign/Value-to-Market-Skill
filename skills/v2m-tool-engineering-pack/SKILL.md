...
## On invocation
Read `references/output-protocol.md`, `references/frameworks.md` (Value to Market, MOA, Value Sequence and Value Network), `references/glossary.md` (Metric Decay Paradox), `references/scorecards.md`. Pull the design, channels, proof and pricing. Ask the team, the tooling, and the launch date.

...
## On invocation
Read `references/output-protocol.md`, `references/report-format.md`, `references/checklist-15.md`, `references/scorecards.md`. Read every reasoning file in the project `Value Strategy/` folder as the source of truth; mark gaps as open decisions.
